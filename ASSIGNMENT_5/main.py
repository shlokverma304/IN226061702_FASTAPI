...
def apply_discount(category: str, discount_percent: int):
    ...
    for p in products:
        if p["category"] == category:
            ...
            updated_products.append({"name": p["name"], "new_price": p["price"]})
    return {"category": category, "discount_percent": discount_percent, "updated_products": updated_products}
...
def add_product(new_product: NewProduct, response: Response):
    ...
    product = {"id": next_id, "name": new_product.name, "price": new_product.price, "category": new_product.category, "in_stock": new_product.in_stock}
...
def add_to_cart(product_id: int, quantity: int = 1):
    ...
    cart_item = {"product_id": product_id, "product_name": product["name"], "quantity": quantity, "unit_price": product["price"], "subtotal": subtotal}
...
def search_products(keyword: str):
    ...
    return {"keyword": keyword, "results": results, "total_found": len(results)}
